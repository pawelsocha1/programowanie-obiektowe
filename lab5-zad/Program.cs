...
public T MemberB { get; init; } public IEnumerator<T> GetEnumerator()
{
...
//Console.WriteLine(rates[Currency.EUR]);enum Currency
{
PLN,
USD,
EUR,
...
//0x2c7d
//...
//0xffffclass Exercise3 : IEnumerable<string>
{
